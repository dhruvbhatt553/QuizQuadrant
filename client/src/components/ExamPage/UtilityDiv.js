...
export default function UtilityDiv(props) {
    ...
    const { candidateName, candidateEmail, questionIds, currQuestionIndex, violationCount, examStart, instructionRead, handleQuestionNumberBtn, handleStartExamBtn, handleFinishExamBtn } = props;

                    ...
                    <div className='border border-blue-300 mx-4 text-start'>
                        ...
                        <div className='px-4 mb-3 cursor-pointer'>
                            <div
                                ...
                                <div
                                    className={`text-[15px] border border-black w-fit px-3 py-1.5 ${question.questionType === 'mcq' ? 'rounded-full' : 'rounded'}`}>
                                    A
                                </div>
                                <div>
                        ...
                        <div
                            className={`float-end  px-2 ${(responses[number - 1][0] || responses[number - 1][1] || responses[number - 1][2] || responses[number - 1][3]) ? "bg-gray-500 cursor-pointer" : " bg-gray-300 cursor-none"}`}

                        ...
                        <div className='border border-blue-300 mx-4 text-start'>
                            <div className='flex justify-between border-b-blue-300 border-b items-center px-4'>
                                ...
                                <div className='flex gap-x-2'>
                                    { (!attempted[number - 1] || (attempted[number - 1] && checkAnswers())) && <div className='bg-yellow-400 p-1 rounded'>
                                        +{ question.positiveMarks }
                                    </div> }

                                    { (!attempted[number - 1] || (attempted[number - 1] && !checkAnswers())) && <div className='bg-red-400 p-1 rounded'>
                            ...
                            {/* Solution */ }
                            { attempted[number - 1] && <div className='px-4'>
